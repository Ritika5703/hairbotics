const DashboardStyles = {
  ...
  mobileToggle:
    "flex md:hidden justify-between items-center bg-gray-800 text-white px-4 py-3",
  mobileTitle: "text-2xl font-bold",
  toggleButton: "focus:outline-none",
  toggleIcon: "text-2xl",
  sidebar:
    "bg-white text-gray-700 w-64 py-7 px-4 shadow-md flex flex-col justify-between transition-transform duration-300", // Set flex-col and justify-between
  ...
  navLink:
    "flex items-center py-2.5 px-4 rounded transition-colors duration-200 text-gray-700 hover:bg-gray-100 hover:text-gray-900",
  navIcon: "mr-3 text-gray-600",
  navText: "text-base font-medium",
  activeLink: "bg-green-100 text-gray-900",
  sidebarFooter:
    "self-end flex flex-col items-center py-4 border-t border-gray-300", // Adjusted to self-end
  ...
  userCard:
    "absolute right-16 top-20 bg-white border border-gray-300 rounded-md shadow-lg p-4 z-50",
